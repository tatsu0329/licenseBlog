...
const certAutoMechanic2: Cert = {
  ...
  examInfo: {
    eligibility:
      "自動車整備士3級取得後、実務経験2年以上、または指定養成施設修了",
    examDates: {
      spring: "令和7年10月5日実施(直近の実施回)", // 令和7年度第1回
      autumn: "2024-11-10",
    },
    passCriteria:
      "学科試験は各試験種目により異なりますが、概ね60点以上、実技試験も60点以上が基準となります。詳細は公式サイトでご確認ください。",
    passRateHistory: [
      {
        year: 2023,
        spring: {
