...
const certAutoMechanic1: Cert = {
  ...
  examInfo: {
    ...
    eligibility:
      "原則として、自動車整備士2級取得後、実務経験3年以上が必要です。ただし、指定養成施設を修了した場合は実務経験が1年以上に短縮されるなど、条件により異なる場合があります。詳細は国土交通省の公式サイトでご確認ください。",
    ...
    examDates: {
      spring: 
      "実施なし", // 年度により変動するため固定値なし（例：令和6年度第1回は2024年6月頃実施）
      autumn:
        "令和7年3月23日実施(直近の実施回)", // 最新の実施日（参考例）
    },
